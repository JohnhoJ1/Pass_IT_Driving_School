    ...
    public partial class Admin_Form : Form
    {
        ...
        private void btnInstructorSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string[] row =  { txtInstructorFirstName.Text, txtInstructorMiddleName.Text, txtInstructorLastName.Text,
                    cmbInstructorJobType.Text,txtInstructorAddress.Text,txtInstructorPhoneNumber.Text};
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] row = { txtFirstName.Text, txtMiddleName.Text,
                        txtLastName.Text, cmbGender.Text, txtAddress.Text , cmbInstructor.Text,dateTimePicker1.Text , cmbCourse.Text };
